...
summary: AI powered research tool utilising the PubMed API
date: 2024-02-20
tags: ['research', 'PubMed', 'literature review', 'AI summarization']
stack: ['Python', 'PubMed API', 'Google Gemini', 'Data Analysis', 'MCP']
status: ongoing
featured: true
demo: #
github: #
website: https://4pmedicine.com
image: /static/images/research.webp
---

## Problem

I needed an efficient way to stay current with the latest research publications in Predictive, Preventative, Personalised, and Participatory medicine to maintain relevant, evidence-based content for my website [4pmedicine.com](https://4pmedicine.com).
